    ...
    <div class="mx-auto flex min-h-screen w-full max-w-[38rem] flex-col px-5 py-7 sm:px-6 sm:py-14 lg:max-w-5xl lg:px-8">
        ...
        <header class="mb-12 flex items-center justify-between gap-4 sm:mb-16">
            <a href="{{ route('upload') }}" wire:navigate class="group inline-flex items-baseline gap-2">
                <span class="font-serif text-[1.35rem] leading-none tracking-tight text-sand-900 dark:text-sand-100">
            ...
            <button
                ...
                "
                class="-m-2 rounded-lg p-2 text-sand-400 transition-colors hover:text-accent-600 dark:text-sand-500 dark:hover:text-accent-300"
                aria-label="Toggle dark mode"
            >
                <svg class="h-[17px] w-[17px] dark:hidden" fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 15.91A9 9 0 1 1 8.09 2.25a7.5 7.5 0 0 0 13.66 13.66Z"/>
                </svg>
                <svg class="hidden h-[17px] w-[17px] dark:block" fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24" aria-hidden="true">
